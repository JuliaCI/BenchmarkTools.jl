...
@test !(isinvariant(judge(g1, g2)))
@test !(isinvariant(time, judge(g1, g2)))
@test isinvariant(memory, judge(g1, g2))
@test isregression(judge(g1, g2))
@test isregression(time, judge(g1, g2))
@test !(isregression(memory, judge(g1, g2)))
@test isimprovement(judge(g1, g2))
@test isimprovement(time, judge(g1, g2))
@test !(isimprovement(memory, judge(g1, g2)))
